    ...
    @section('content')
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first mt-4">
                    <h1>{{ __('Registro') }} <i class="fas fa-user-edit"></i></h1>
                </div>
                ...
                <!-- Remind Passowrd -->
                <div id="formFooter">
                    <a class="underlineHover" href="{{ url('/') }}">Salir <i class="fas fa-sign-out-alt"></i></a>
                </div>
        ...
        {{-- <div class="container mt-4">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header text-center" style="font-size:27px">{{ __('Registro') }} <i
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 lead text-md-right">{{ __('Nombre') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="email"
                                        class="col-md-4 lead text-md-right">{{ __('Correo electronico') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password"
                                        class="col-md-4 lead text-md-right">{{ __('Password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm"
                                        class="col-md-4 lead text-md-right">{{ __('Confirm Password') }}</label>
